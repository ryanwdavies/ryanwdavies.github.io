...
*   **Other:** Linux, MySQL, git, JIRA, AWS, Delphix, Docker, Remix/Ganache/Truffle, Excel, TOAD, Apache<br><br>
...
<p style='text-align: justify;'> 
Bespoke tooling: designed and build a custom extensible framework for automated environment control, monitoring, and deployment - Python, Jython, PL/SQL, shell script.

System provisioning: designed and built an automated environment cloning solution, integrated with Delphix data virtualisation/TDM - PL/SQL, Python, Jython, shell script. <br /><br />

DevOps tooling: BMC BladgeLogic and Release Automation, and Delphix data virtualisation / TDM - configuration, support, scripting for implementation Docker container proof of concept for Oracle FMW.<br /><br />
